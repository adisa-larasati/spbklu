...
class UACController extends Controller
{
    ...
    public function PerformLogin(Request $request){
        ...
        if( count($check) == 1 ){
            ...
            Session::put('popup_message', base64_encode("Login success. Welcome back."));
            ...
            Session::put('popup_message', base64_encode("Invalid login. Please try again."));
    ...
    public function ChangeMyPassword(Request $request){
        ...
        if( $this_current_user->PASSWORD != md5($request->current_password) ){
            Session::put('show_popup', base64_encode(1));
            Session::put('popup_type', base64_encode("error"));
